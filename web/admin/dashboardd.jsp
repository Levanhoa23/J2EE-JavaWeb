                                ...
                                <tbody>
                                    <c:forEach var="order" items="${orderList}" varStatus="status">
                                        <tr>
                                            ...
                                            <td><a href="IndexOrderItemSerlvet?orderId=${order.id}">${order.code}</a></td>
                                            <td>${order.status}</td>
                                            <td>
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-4">
                            <div class="h-100 bg-secondary rounded p-4">
                                ...
                                <div class="d-flex align-items-center border-bottom py-3">
                                    <img class="rounded-circle flex-shrink-0" src="./assets/admin/img/lvh.png" alt="" style="width: 40px; height: 40px;">
